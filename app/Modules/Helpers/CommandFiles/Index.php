...
include_once(__DIR__ . '\BackendModule\Database\Seeder.php');
...
include_once(__DIR__ . '\FrontendModule\Setup\Layout.php');
include_once(__DIR__ . '\FrontendModule\Setup\Router.php');
include_once(__DIR__ . '\FrontendModule\Setup\SetupIndex.php');
include_once(__DIR__ . '\FrontendModule\Setup\StateManagement.php');
