            ...
            <ul class="navbar-nav align-items-center right-nav-link ml-auto">
                <li class="nav-item dropdown language">
                    <a
                        ...
                        aria-expanded="false"
                        ><i class="flag-icon flag-icon-gb align-middle"></i
                    ></a>
                                    ...
                                    <div class="media">
                                        <div class="avatar">
                                            <img
                                                ...
                                                src="backend/assets/images/avatars/avatar-5.png"
                                                alt="user avatar"
                                            />
                                        </div>
                                ...
                                <a href="javaScript:void();">
                                    <div class="media">
                                        <div class="avatar">
                                            <img
                                                class="align-self-start mr-3"
                                                src="backend/assets/images/avatars/avatar-6.png"
                                                alt="user avatar"
                                            />
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javaScript:void();">
                                    <div class="media">
                                        <div class="avatar">
                                            <img
                                                class="align-self-start mr-3"
                                                src="backend/assets/images/avatars/avatar-7.png"
                                                alt="user avatar"
                                            />
                                        </div>
                                        <div class="media-body">
                                ...
                                <a href="javaScript:void();">
                                    <div class="media">
                                        <div class="avatar">
                                            <img
                                                class="align-self-start mr-3"
                                                src="backend/assets/images/avatars/avatar-8.png"
                                                alt="user avatar"
                                            />
                                        </div>
                                        <div class="media-body">
                        ...
                        <ul class="list-group list-group-flush">
                            ...
                            <li class="list-group-item">
                                <a href="javaScript:void();">
                                    <div class="media">
                                        <i
                                            class="zmdi zmdi-accounts fa-2x mr-3 text-info"
                                        ></i>
                                        <div class="media-body">
                                            <h6 class="mt-0 msg-title">
