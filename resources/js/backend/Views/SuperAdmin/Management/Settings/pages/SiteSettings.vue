                        ...
                        <div class="d-flex">
                                ...
                                <li class="nav-item" @click="tab = 'smtp'">
                                    <a :class="tab == 'smtp' ? ' active' : ''" href="javascript:void();"
                                        data-target="#smtp" data-toggle="pill" class="nav-link"><i
                                            class="icon-note"></i> <span class="hidden-xs">SMTP Settings</span></a>
                                    <hr>
                                </li>
                            ...
                            <div class=" ml-2 flex-grow-1 tab-content p-3 card">
                                <div v-if="tab == 'bassic_settings'" :class="tab == 'bassic_settings' ? ' active' : ''"
                                    ...
                                    <form @submit.prevent="BasicSettingsHandler" enctype="multipart/form-data">
                                ...
                                <div v-if="tab == 'smtp'" :class="tab == 'smtp' ? ' active' : ''" class="tab-pane"
                                    ...
                                    <form @submit.prevent="saveSocialLinks">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-9">
                                                <input name="port" class="form-control" type="text" placeholder="465">
                                            </div>
                                        </div>
...
export default {
    ...
    methods: {
        ...
        BasicSettingsHandler: async function () {
